...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        return httpSecurity.csrf(AbstractHttpConfigurer::disable).authorizeHttpRequests(request -> request
                ...
                .requestMatchers(BASE_URL + "/user/**", BASE_URL + "/notifications/**", BASE_URL + "/announcement/getAnnouncementsByCompanyId", BASE_URL + "/announcement/getAnnouncementsByDepartmentId", BASE_URL + "/announcement/get-By-EmployeeId", BASE_URL + "/announcement/{id}", BASE_URL + "/announcement/get-main-previews", BASE_URL + "/announcement/get-sub-previews", BASE_URL + "/comments/add", BASE_URL + "/comments/getById/**",BASE_URL + "/announcement/monthly_announcement").authenticated()

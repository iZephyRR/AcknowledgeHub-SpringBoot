...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        return httpSecurity.csrf(AbstractHttpConfigurer::disable).authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers(BASE_URL + "/mr/**", BASE_URL + "/announcement/aug-to-oct-2024", BASE_URL + "/announcement/get-all", BASE_URL + "/announcement/count").hasRole(EmployeeRole.MAIN_HR.name())
                        ...
                        .requestMatchers(BASE_URL + "/mha/**").hasAnyRole(EmployeeRole.MAIN_HR.name(), EmployeeRole.MAIN_HR_ASSISTANCE.name())
                        .requestMatchers(BASE_URL+"/hrs/**",BASE_URL + "/announcement/create", BASE_URL + "/announcement/uploadDraft", BASE_URL + "/announcement/get-drafts", BASE_URL + "/getCompanyById/**", BASE_URL + "/get-categories", BASE_URL + "/announcement/getDraftById/**", BASE_URL + "/announcement/delete-draft/**", BASE_URL + "/custom-target/**").hasAnyRole(EmployeeRole.MAIN_HR.name(), EmployeeRole.HR.name(), EmployeeRole.MAIN_HR_ASSISTANCE.name(), EmployeeRole.HR_ASSISTANCE.name()))

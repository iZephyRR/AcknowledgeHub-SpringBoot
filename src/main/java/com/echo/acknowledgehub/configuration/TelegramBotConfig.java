...
public class TelegramBotConfig {
    ...
    @Bean
    public TelegramService telegramService(EmployeeService employeeService, TelegramGroupService telegramGroupService, FirebaseNotificationService firebaseNotificationService) {
